...
class QB extends PDO {
     ...
     * @return $this
     */
    public function Select( mixed $columns = null ): QB {
        if( is_null($columns) ) {
            $this->sql = "SELECT *";
     ...
     * @return $this
     */
    public function Insert( string $table ): QB {
     ...
     * @return $this
     */
    public function Update( string $table ): QB {
     ...
     * @return $this
     */
    public function Delete( string $table ): QB {
     ...
     * @return $this
     */
    public function Truncate( string $table ): QB {
     ...
     * @throws SystemException
     */
    public function Set( array $columns, array $values = [] ): QB {
     ...
     * @throws SystemException
     */
    public function Columns( array $columns, array $values = [] ): QB {
     ...
     * @throws SystemException
     */
    public function From( mixed $tables = null ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
        if( is_null($tables) ) {
     ...
     * @throws SystemException
     */
    public function Join( string $table ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function leftJoin( string $table ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function rightJoin( string $table ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function On( mixed $conditions ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function openGroup( mixed $conditions, string $operator = "OR" ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
        $this->sql .= " (";
     ...
     * @throws SystemException
     */
    public function Where( string $condition ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function And( string $condition = "" ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
        $this->sql.= " AND";
     ...
     * @throws SystemException
     */
    public function Or( string $condition = "" ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
        $this->sql .= " OR";
     ...
     * @throws SystemException
     */
    public function Like( string $condition ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function notLike( string $condition ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function In( array $values ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function notIn( array $values ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function Between( mixed $condition1, mixed $condition2 ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function notBetween( mixed $condition1, mixed $condition2 ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function SubQuery(QB $builder, string $alias = "", string $condition = ""): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
     ...
     * @throws SystemException
     */
    public function As( string $alias ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
        $this->sql .= " AS " . $alias;
     ...
     * @throws SystemException
     */
    public function OrderBy( mixed $columns, string $order = "ASC" ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
        $this->sql.= " ORDER BY";
     ...
     * @throws SystemException
     */
    public function GroupBy( mixed $columns ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
        if( is_array($columns) ) {
     ...
     * @throws SystemException
     */
    public function Having( string $condition ): QB {
        if( $this->sql === "" ) {
            throw new SystemException(__FILE__, __LINE__, "Error in query Syntax");
        }
