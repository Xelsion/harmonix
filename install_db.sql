...
INSERT INTO `access_restrictions` (`domain`, `controller`, `method`, `restriction_type`, `role_id`, `created`, `updated`, `deleted`) VALUES
	('admin', NULL, NULL, 1, 1, '2022-04-06 13:28:41', NULL, NULL),
	('admin', 'controller\\admin\\ActorController', NULL, 1, 2, '2022-04-06 13:28:41', NULL, NULL),
	('admin', 'controller\\admin\\ErrorController', NULL, 1, 4, '2022-04-06 13:28:41', NULL, NULL),
	('www', NULL, NULL, 3, 3, '2022-04-06 13:28:41', NULL, NULL),
	('www', 'controller\\www\\ErrorController', NULL, 1, 4, '2022-04-06 13:28:41', NULL, NULL),
	('www', 'controller\\www\\HomeController', NULL, 1, 4, '2022-04-06 13:28:41', NULL, NULL);
...
INSERT INTO `access_restriction_types` (`id`, `name`, `include_siblings`, `include_children`, `include_descendants`, `created`, `updated`, `deleted`) VALUES
	(1, 'Only This', 0, 0, 0, '2022-04-06 11:03:52', NULL, NULL),
	(2, 'Same Parent', 1, 0, 0, '2022-04-06 11:03:52', NULL, NULL),
	(3, 'Include only Children', 0, 1, 0, '2022-04-06 11:03:52', NULL, NULL),
	(4, 'Include All Descendants', 0, 0, 1, '2022-04-06 11:03:52', NULL, NULL);
...
INSERT INTO `actors` (`id`, `email`, `password`, `first_name`, `last_name`, `login_fails`, `login_disabled`, `created`, `updated`, `deleted`) VALUES
	(1, 'admin@localhost.de', '$2y$10$D3JrwZhUeKJ7b2XZnnhXMu5byRZFpIBg07rNSMqIRtf0tNFvEMFZ.', 'Markus', 'Schröder', 0, 0, '2022-02-27 01:45:19', '2022-04-06 12:36:31', NULL);
...
-- Exportiere Daten aus Tabelle mvc.sessions: ~0 rows (ungefähr)
/*!40000 ALTER TABLE `sessions` DISABLE KEYS */;
INSERT INTO `sessions` (`id`, `actor_id`, `ip`, `expired`, `created`, `updated`, `deleted`) VALUES
	('f6d5d837cb21c10657e9a7d2067da5f1', 1, '127.0.0.1', '2022-04-06 16:06:22', '2022-04-06 11:04:35', '2022-04-06 14:06:22', NULL);
